...
let albumAustralia = new Album(
  "Australie",
  "albumAu.html",
  [
    "./src/assets/galery/carouselle/au1.jpg",
    "./src/assets/galery/carouselle/au2.jpg",
    "./src/assets/galery/carouselle/au3.jpg",
  ],
  ["photo album australie", "photo album australie", "photo album australie"]
);
let albumNewZeland = new Album(
  "Nouvelle Zelande",
  "albumNZ.html",
  [
    "./src/assets/galery/carouselle/nz1.jpg",
    "./src/assets/galery/carouselle/nz2.jpg",
    "./src/assets/galery/carouselle/nz3.jpg",
  ],
  ["photo album NZ", "photo album NZ", "photo album NZ"]
);
let albumVan = new Album(
  "Van",
  "album-van.html",
  [
    "./src/assets/galery/carouselle/van1.jpg",
    "./src/assets/galery/carouselle/van2.jpg",
    "./src/assets/galery/carouselle/van3.jpg",
  ],
  ["photo album Van", "photo album Van", "photo album Van"]
);
